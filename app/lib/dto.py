...
if TYPE_CHECKING:
    from collections.abc import Set as myAbstractSet

    from litestar.dto import RenameStrategy

__all__ = ["config", "dto_field", "DTOConfig", "SQLAlchemyDTO", "SQLAlchemyDTOConfig", "DataclassDTO"]
...
def config(
        ...
        exclude: myAbstractSet[str] | None = None,
